...
const BANNERS = [
  ...
  },
  {
    id: '2',
    categoryId: 'cleaning',
    serviceId: 'clean-3', // Points to Kitchen Cleaning
    image: 'https://plus.unsplash.com/premium_photo-1679500355684-8be166ab95ab?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
...
export const serviceImages: Record<string, string> = {
  "clean-1": "https://static.wixstatic.com/media/b4ca61_4f38273ed6a241738b30e30b5ba4184a~mv2.png/v1/fill/w_764,h_382,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/b4ca61_4f38273ed6a241738b30e30b5ba4184a~mv2.pnghttps://tse2.mm.bing.net/th/id/OIP.HNXM4_l_YntVySCfCFmX4wHaE7?rs=1&pid=ImgDetMain&o=7&rm=3",
  "clean-2": "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400",
  "plumb-1": "https://johnnyrooter.com/wp-content/uploads/2025/02/AdobeStock_1026063643.webp",
  "elec-1": "https://images.unsplash.com/photo-1632394128474-b8c3dca00f83?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "paint-1": "https://plus.unsplash.com/premium_photo-1683121602687-60c47b2222f0?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "salon-1": "https://img.freepik.com/free-photo/beautiful-woman-has-cutting-hair-hairdresser_329181-1942.jpg",
}
  ...
  const handleSendAI = async () => {
    ...
    try {
      ...
      if (data.reply) {
        ...
        const errorMsg = data.error || 'Sorry, I encountered an issue. Please try again.';
        setAiMessages(prev => [...prev, { role: 'ai', text: errorMsg }]);
      }
    } catch (e) {
      setAiMessages(prev => [...prev, { role: 'ai', text: 'Sorry, I could not connect to the AI service. Please check your internet connection.' }]);
    } finally {
