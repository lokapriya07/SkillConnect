            ...
            <View style={styles.header}>
                ...
                <View style={styles.searchContainer}>
                    ...
                    <TextInput
                        ...
                        value={query}
                        onChangeText={setQuery}
                        onSubmitEditing={() => handleSearchSubmit(query)} // UPDATED: Add to recent on enter
                            ...
                            {categories.slice(0, 5).map((category) => (
                                <TouchableOpacity 
                                    ...
                                    onPress={() => {
                                        ...
                                        handleSearchSubmit(category.name); // Also add category to recent
                                    }}
                                >
                                    <View style={[styles.categoryIcon, { backgroundColor: category.color, opacity: 0.15 }]} />
                                    <View style={styles.categoryIconOverlay}><Search size={20} color={category.color} /></View>
...
const styles = StyleSheet.create({
    ...
    tagWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.muted, borderRadius: 20, paddingRight: 8 },
    ...
    applyButton: { flex: 2, padding: 14, alignItems: "center", borderRadius: 8, backgroundColor: COLORS.primary },
    applyButtonText: { color: "#FFF", fontWeight: "600" },
    activeFiltersScroll: { backgroundColor: COLORS.background, borderBottomWidth: 1, borderBottomColor: COLORS.border, paddingVertical: 10 },
    activeFiltersInner: { paddingHorizontal: 16, gap: 8, flexDirection: 'row' },
    activeFilterBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.muted, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, gap: 6, borderWidth: 1, borderColor: COLORS.border },
