...
export default function CartScreen({ onBack, onCheckout }: CartScreenProps) {
    ...
    const { cart, updateCartItemQuantity, removeFromCart, darkMode } = useAppStore()

    // Theme colors - these are used throughout the component
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.emptyContainer}>
                    <Ionicons name="cart-outline" size={80} color={textSecondaryColor} />
