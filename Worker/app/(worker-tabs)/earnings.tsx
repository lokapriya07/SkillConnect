        ...
        <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            <Card style={styles.pointsCard}>
                <CardContent style={styles.pointsCenter}>
                    ...
                    {stats.availablePoints === 0 && (
                        <Text style={styles.pointsSubtitle}>Earn points by completing jobs</Text>
                    )}
            ...
            {transactions.length === 0 ? (
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyStateText}>No points yet. Complete jobs to start earning!</Text>
                </View>
            ) : (
                transactions.map((tx) => (
